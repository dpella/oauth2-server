...
- `cabal repl oauth-server` — open a REPL for the library (useful for quick iteration).
...
- Update `oauth-server.cabal` when adding/renaming modules; update README/examples if API changes.
